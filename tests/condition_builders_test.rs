...
mod condition_builder_tests {
    use openscenario_rs::builder::conditions::{
        DistanceConditionBuilder, SpeedConditionBuilder, TimeConditionBuilder, TriggerBuilder,
    };
    ...
    fn test_trigger_builder_multiple_groups() {
        let time_condition1 = TimeConditionBuilder::new().at_time(3.0).build().unwrap();

        let time_condition2 = TimeConditionBuilder::new().at_time(10.0).build().unwrap();
