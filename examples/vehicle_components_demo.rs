...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "Pedestrian dimensions: {:.1}m × {:.1}m × {:.1}m",
    ...
    println!(
        "Car: {} axles, wheelbase: {:.2}m, steerable: {}",
    ...
    println!(
        "Truck: {} axles, wheelbase: {:.2}m, steerable: {}",
    ...
    println!(
        "Trailer: {} axles, wheelbase: {:.2}m, steerable: {}",
    ...
    println!(
        "Motorcycle: {} axles, wheelbase: {:.2}m, steerable: {}",
    ...
    println!(
        "Motorcycle '{}': {} axles, footprint: {:.2}m²",
